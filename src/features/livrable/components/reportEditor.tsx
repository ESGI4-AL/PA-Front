...
const ReportEditor: React.FC<ReportEditorProps> = ({ report, setReport }) => {
  ...
  return (
    <div className="mt-16 mb-16 max-w-4xl mx-auto px-6">
      <h2 className="text-4xl font-bold text-white mb-6">&gt; Rapport</h2>
      ...
      {mode === 'edit' && (
        <div className="bg-white rounded-lg shadow p-6 space-y-4">
          {editor && (
            <>
              <div className="flex flex-wrap gap-2 mb-4 border-b pb-2">
                ...
                {toolbarButton(editor.isActive('codeBlock'), () => editor.chain().focus().toggleCodeBlock().run(), <FaCode />, 'Bloc de code')}
          ...
          <div id="report-content" className="border border-gray-300 rounded-md p-4 bg-white text-black min-h-[200px] prose prose-slate max-w-none">
